...
async function main() {
  console.log('🌱 Seeding FastTackle Africa...');
  ...
  // ── BRAND IDENTITY (admin-editable — Wordmark component reads these) ──
  ...
  await prisma.pageContent.upsert({
    ...
    create: {
      ...
      title: 'About Us',
      body: {
        heroHeading: 'About FastTackle Africa',
        heroImage: 'https://images.unsplash.com/photo-1515658323406-25d61c141a6e?w=1920&h=650&fit=crop&crop=entropy&q=80',
        theoryKicker: 'Our Approach',
        theoryHeading: 'Theory of Change',
        theoryText: 'If creatives are given a trusted platform to sell their work alongside credible charitable partners, and if buyers get transparent ways to purchase products that directly finance SDG-aligned projects, then creative commerce becomes a sustainable source of philanthropic capital that strengthens nonprofits, empowers creative entrepreneurs, and delivers measurable improvements in communities worldwide.',
        theoryCta: 'Explore the Marketplace',
        theoryImage: 'https://images.unsplash.com/photo-1473649085228-583485e6e4d7?w=900&h=1100&fit=crop&q=80',
        stats: [
          { end: 58, prefix: '$', suffix: 'B', label: "Africa's Creative Economy" },
          { end: 550, prefix: '$', suffix: 'B', label: 'Global Giving Annually' },
          { end: 712, suffix: 'M', label: 'In Extreme Poverty' },
          { end: 13, label: 'SDGs Supported' },
        ],
        vision: 'Make creativity a driver of social change by helping artists, designers, makers, photographers, musicians, and writers fund high-impact, SDG-aligned community projects worldwide.',
        problem: "Creatives struggle to monetize their work for lasting impact, while charities and community initiatives face chronic funding gaps. Donation-dependent fundraising is unpredictable and unsustainable. There's a need for financing that links creativity, commerce, philanthropy, and measurable impact.",
        solution: 'FastTackle Africa is a global marketplace where creatives sell original work and partner with verified nonprofits. A set percentage of every sale automatically funds SDG-aligned community projects. Buyers get creative work and fund measurable social change with transparent impact tracking, project verification, and financial accountability.',
      },
    },
  });
